...
public interface Repository <T, K extends Serializable> extends Serializable {
     ...
     * 
     * @param key el ID de la entidad a buscar.
     ...
     * 
     * <p><strong>Importante:</strong> Usar con mucha prudencia ya que puede 
     * desbordar la memoria del servidor si existen muchos datos.</p>
     * 
     * <p><strong>Recomendación:</strong> Se sugiere el uso de 
     ...
     * @param key el ID de la entidad a eliminar.
     */
     ...
     * posición fija.
     *
     * @param cantidadResultados la cantidad de entidades que se consultará.
     * @param primerResultado la posición por la que se iniciará la consulta.
     * @return una lista con las entidades que están en el almacen de datos.
     */

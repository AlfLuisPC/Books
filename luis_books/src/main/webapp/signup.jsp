        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form id="login-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <button id="login-btn" type="submit" class="btn btn-primary btn-block btn-flat">Registrarse</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
				<br/>
                <a href="${pageContext.request.contextPath}/login.jsp">Regresar</a><br>
            </div>
        </div>
        	...
        	$("#login-btn").click(
				function(event) {
					...
					console.log(credenciales);
						...
						$.ajax({
							type : "POST",
							url : "${pageContext.request.contextPath}/registro/usuario",
